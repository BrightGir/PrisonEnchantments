...
public class ArmorListener implements Listener {
    ...
    public final void onInventoryClick(final InventoryClickEvent e) {
        ...
        if (shift) {
          ...
          //    final ArmorEquipEvent armorEquipEvent = new ArmorEquipEvent(player, method, newArmorType, oldArmorPiece, newArmorPiece);
          //    Bukkit.getScheduler().scheduleSyncDelayedTask(PEnchantments.getPlugin(), () -> {
    ...
    public void playerInteractEvent(PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) {
            ...
            ItemStack armour = e.getPlayer().getInventory().getItemInMainHand();
            ArmorType newArmorType = ArmorType.matchType(armour);
            if (newArmorType != null) {
                if (newArmorType == ArmorType.HELMET && e.getPlayer().getInventory().getHelmet() == null || newArmorType == ArmorType.CHESTPLATE && e.getPlayer().getInventory().getChestplate() == null || newArmorType == ArmorType.LEGGINGS && e.getPlayer().getInventory().getLeggings() == null || newArmorType == ArmorType.BOOTS && e.getPlayer().getInventory().getBoots() == null) {
                    ArmorEquipEvent armorEquipEvent = new ArmorEquipEvent(e.getPlayer(), ArmorEquipEvent.EquipMethod.HOTBAR, ArmorType.matchType(armour), null, armour);
                    Bukkit.getServer().getPluginManager().callEvent(armorEquipEvent);
                    if (armorEquipEvent.isCancelled()) {
                        e.setCancelled(true);
    ...
    public void playerDeathEvent(PlayerDeathEvent e) {
        ...
        for (ItemStack i : p.getInventory().getArmorContents()) {
            if (i != null && i.getType() != Material.AIR) {
                Bukkit.getServer().getPluginManager().callEvent(new ArmorEquipEvent(p, ArmorEquipEvent.EquipMethod.DEATH, ArmorType.matchType(i), i,i));
